...
<div class="create-box" id="form">
    <form action="/mitumorisho_pdf" method="POST" target="blank">
        @csrf
        <div class="box">
        <label for="from">From</label><input type="text" name="from" id="from" v-model="from" required> 
        <p id="subtext1">スペースで改行</p>
        <label for="for">For</label><input type="text" name="for_for" id="for" v-model="For" required>
        <p id="subtext1">スペースで改行</p>
        <label for="date">見積日</label><input type="date" name="date" id="date" v-model="date" required>
        <label for="deadline">有効期限</label><input type="date" name="deadline" id="deadline" v-model="deadline" required>
        <label for="subject">件名</label><input type="text" name="subject" id="subject" v-model="subject">
        <label for="number">見積No</label><input type="number" name="number" id="number" value="1" v-model="number">
        ...
        <div class="summary">
            ...
            <div class="content">品目</div><div class="unit_price">単価</div><div class="quantity">数量</div><div class="rate">税率</div>
                @for($i=1; $i<=18; $i++)
                <input type="text" name="content_{{ $i }}" class="content" id="content_{{ $i }}" v-model="content_{{ $i }}">
                <input type="number" name="unit_price_{{ $i }}" class="unit_price" id="unit_price_{{ $i }}" v-model="unit_price_{{ $i }}">
        ...
        <div class="box">
            <label for="remarks">備考</label><textarea name="remarks" id="remarks" cols="30" rows="10" v-model="remarks"></textarea>
        </div>
