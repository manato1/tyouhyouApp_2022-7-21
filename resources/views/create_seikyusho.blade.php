...
<div class="create-box" id="form">
    <form action="/seikyusho_pdf" method="POST" target="blank">
        @csrf
        <div class="box">
        <label for="from">From</label><input type="text" name="from" id="from" value="" v-model="from" required> 
        <p id="subtext1">スペースで改行</p>
        <label for="for">For</label><input type="text" name="for_for" id="for" value="" v-model="For" required>
        <p id="subtext1">スペースで改行</p>
        <label for="date">請求日</label><input type="date" name="date" id="date" value="" v-model="date" required>
        <label for="deadline">有効期限</label><input type="date" name="deadline" id="deadline" value="" v-model="deadline" required>
        <label for="subject">件名</label><input type="text" name="subject" id="subject" value="" v-model="subject">
        <label for="number">請求No</label><input type="number" name="number" id="number" value="1" v-model="number">
